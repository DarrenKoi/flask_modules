"""
Unit tests for dags/lib/orders.py.

The whole point of extracting logic into `lib/` is that we can test it
without spinning up Airflow. These tests just `import lib.orders` and
